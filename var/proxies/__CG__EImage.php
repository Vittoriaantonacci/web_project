 ...
 */
class EImage extends \EImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EImage $proxy) {
    ...
    public function getIdImage(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdImage', []);
    ...
    public function setImagePath(string $path): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImagePath', [$path]);
